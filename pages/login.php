...
<body class="bg-gradient-primary">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Bienvenue dans le Système de Gestion de Stock !</h1>
                  </div>
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <button class="btn btn-primary btn-user btn-block" type="submit" name="btnlogin">Se connecter</button>
                    <hr>
                  <!-- <div class="text-center">
  ...
  <!-- JavaScript des plugins de base -->
